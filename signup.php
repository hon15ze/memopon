...
if(!empty($_POST)){
    ...
    if(empty($err_msg)){
        ...
        try {
            ...
            $data = array(':username' => $name, ':email' => $email, ':pass' => password_hash($pass, PASSWORD_DEFAULT),
        ...
        if($stmt){
            ...
            $from = '＊＊＊＊＊＊@gmail.com';
            $to = $email;
            $subject = '【ユーザー登録完了のお知らせ】|memopon';

            $comment = <<<EOF
{$name} 様
この度はmemoponにご登録いただき、誠にありがとうございます。
下記のURLからログインしてサービスをお楽しみください。

ログインページ：http://localhost:8888/memopon/login.php
////////////////////////////////////////
memopon運営
URL http://localhost:8888/memopon/index.php
E-mail ＊＊＊＊＊＊＊＊＊＊＊
////////////////////////////////////////
EOF;
